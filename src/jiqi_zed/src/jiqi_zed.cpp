...
int main(int argc, char **argv) {
    ...
    {
        std::ifstream class_file("/home/jiqi/jiqi_jetson/src/jiqi_zed/coco.names.txt");
        if (!class_file) {
    ...
    auto net = cv::dnn::readNetFromDarknet("/home/jiqi/jiqi_jetson/src/jiqi_zed/yolov4.cfg", "/home/jiqi/jiqi_jetson/src/jiqi_zed/yolov4.weights");
